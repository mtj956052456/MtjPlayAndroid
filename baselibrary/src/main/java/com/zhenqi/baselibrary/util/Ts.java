...
public class Ts {
    ...
    public static void showShort( CharSequence message) {
        if (isShow) {
            if (mToast == null) {
                mToast = Toast.makeText(BaseApp.getApp(), message, Toast.LENGTH_SHORT);
            } else {
    ...
    public static void showShort( int resId) {
        if (isShow) {
            if (mToast == null) {
                mToast = Toast.makeText(BaseApp.getApp(), resId, Toast.LENGTH_SHORT);
            } else {
    ...
    public static void showLong( CharSequence message) {
        if (isShow) {
            if (mToast == null) {
                mToast = Toast.makeText(BaseApp.getApp(), message, Toast.LENGTH_LONG);
            } else {
                mToast.setText(message);
            }
            mToast.show();
    ...
    public static void showLong( int resId) {
        if (isShow) {
            if (mToast == null) {
                mToast = Toast.makeText(BaseApp.getApp(), resId, Toast.LENGTH_LONG);
            } else {
                mToast.setText(resId);
            }
            mToast.show();
    ...
    public static void show( CharSequence message, int duration) {
        if (isShow) {
            if (mToast == null) {
                mToast = Toast.makeText(BaseApp.getApp(), message, duration);
            } else {
                mToast.setText(message);
            }
            mToast.show();
    ...
    public static void show( int resId, int duration) {
        if (isShow) {
            if (mToast == null) {
                mToast = Toast.makeText(BaseApp.getApp(), resId, duration);
            } else {
                mToast.setText(resId);
            }
            mToast.show();
    ...
    public static void showToastWithImageAndText( CharSequence message, int iconResId, int duration, int gravity, int xOffset, int yOffset) {
        if (isShow) {
            ...
            ImageView imageView = new ImageView(BaseApp.getApp());
