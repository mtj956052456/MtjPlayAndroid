...
public class EncryptionUtil {
     ...
     * 旧版 palmapi 接口的加密
     */
    public static String getRequestMsgPalmapi(String method, Map<String, String> map) {
        String secret = "4ab4aca1c61c78b89338c3e3804e0e9d" + method ;
        for (String key : map.keySet()) {
            secret += map.get(key);
        }
        return Md5Util.getMd5(secret);
    }

    /**
     * 旧版 palmapi 接口的解密
     */
    public static String getResultPalmapi(String result) {
        return new String(Base64.decode(result, Base64.DEFAULT));
    }
}
